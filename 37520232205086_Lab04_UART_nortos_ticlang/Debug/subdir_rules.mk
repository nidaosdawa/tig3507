...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"D:/01soft/TI/CSS/ccs/tools/compiler/ti-cgt-armllvm_3.2.2.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O2 -I"D:/03project/2025/TIproject/37520232205086_Lab04_UART_nortos_ticlang" -I"D:/03project/2025/TIproject/37520232205086_Lab04_UART_nortos_ticlang/Debug" -I"D:/01soft/TI/mspmo_sdk/mspm0_sdk_2_06_00_05/source/third_party/CMSIS/Core/Include" -I"D:/01soft/TI/mspmo_sdk/mspm0_sdk_2_06_00_05/source" -gdwarf-3 -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-961548671: ../main_lab04.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"D:/01soft/TI/CSS/ccs/utils/sysconfig_1.21.0/sysconfig_cli.bat" --script "D:/03project/2025/TIproject/37520232205086_Lab04_UART_nortos_ticlang/main_lab04.syscfg" -o "." -s "D:/01soft/TI/mspmo_sdk/mspm0_sdk_2_06_00_05/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-961548671 ../main_lab04.syscfg
device.opt: build-961548671
device.cmd.genlibs: build-961548671
ti_msp_dl_config.c: build-961548671
ti_msp_dl_config.h: build-961548671
Event.dot: build-961548671
